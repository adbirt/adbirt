        ...
        <div class="p-a-2 tab-content">
          <div class="tab-pane active" id="first">
            {!! Form::open(array('route' => 'password.doChange', 'class' => 'form-horizontal')) !!}
              ...
              <div class="form-group row">
                 {!! Form::label('password_confirmation', 'Confirm New Password', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-6 col-md-4">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon3">
								<i class="material-icons md-18 text-muted">lock</i>
                ...
                <div class="col-sm-8 col-sm-offset-3">
                  <div class="media">
                    <div class="media-left">
					 {!! Form::submit('Reset Password', array('class' => 'btn btn-primary btn-rounded')) !!}
                    </div>
