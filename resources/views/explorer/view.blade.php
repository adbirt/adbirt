    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <div class="card-block">
         <p class="text-muted center">You seem to be Interested in the 360 Explorer APPLICATIONS, you aren't alone and we gat your back on this.<br />NOTE: Get Early Bird Access today by going PRO with just $10 and gain access to the APPLICATIONS for Life.</p>
        </div>
      </div>
		   ...
		   <div class="card">
            <div class="card-block">
               ...
               <br><br>
            <center><h3>Our Premium Partners</h3>
            <div class="gap"></div>
            <div class="gap"></div><br>
            <a href="https://www.payza.com" target="_blank"><img src="http://localhost/wallet/public/uploads/payza.png" alt="Fortumo" width="80"></a>
            <a href="https://fortumo.com/" target="_blank"><img src="http://localhost/wallet/public/uploads/fortumo.png" alt="Fortumo" width="80"></a>
            <a href="https://stripe.com/" target="_blank"><img src="http://localhost/wallet/public/uploads/stripe.png" alt="Fortumo" width="80"></a>
            <a href="https://www.skrill.com" target="_blank"><img src="http://localhost/wallet/public/uploads/skrill.gif" alt="Fortumo" width="80"></a>
            </center>
            <br>
<center><button type="submit" class="btn btn-success btn-rounded">Go PRO</button></center>
			 ...
			 <div class="card card-stats-success">
        <div class="card-block">
         <center>360 Explorer will be delivered to you in Partnership with selected Customer Centric Organizations known as Premium Partners. <a href="{!! URL::route('pending.create') !!}">Learn More</a></center>
        </div>
      </div>
