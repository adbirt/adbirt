...
<body>
    ...
    <div class="page-wrapper">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a href="/actions-and-events" class="nav-link">Actions and events</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="adbirt-content clearfix">
            <div class="adbirt-page-heading adbirt-size-md adbirt-dynamic-bg"
                ...
                <div class="container">
                    <div class="adbirt-page-heading-in text-center">
                        <h1 class="adbirt-page-heading-title">404</h1>
            ...
            <!-- error SECTION START-->
            <section id="error" class="adbirt-error-area adbirt-section-padding">
                <div class="container">
                    <div class="row clearfix">
                        <div
                            class="col-lg-8 col-md-8 offset-lg-2 offset-md-2 col-12 adbirt-single-details text-center">
                            <div class="error-content text-center">
                                <img src="/public/assets-revamp/img/404.png" alt="error">
                                <!-- <div class="blog_search">
         <input type="text" class="form-control" placeholder="Search...">
         <a href="#"><i class="fas fa-search"></i></a>
        </div> -->
                                <h2>Page Not Found</h2>
                                <p class="mt-3 mb-5">The page you are looking for might have been removed had its name
                                    changed or The page you are looking for might have been had its name changed or is
                                    temporarily unavailable.</p>
                                <a href="/" class="adbirt-themes-btn red mt-3">Go to Home</a>
                            </div>
                        </div>
                    </div>
                    <!--- END ROW -->
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-4 col-12 adbirt-footer-link">
                                <div class="adbirt-footer-box">
                                    ...
                                    <div class="adbirt-footer-social-icon mt-3">
                                        ...
                                        <a target="_blank" href="https://www.instagram.com/adbirthq/" class="icon">
                            ...
                            <div class="col-lg-2 col-md-3 col-12 adbirt-footer-link">
                                ...
                                <ul class="adbirt-list-menu">
                                    <li> <a href="/blog"><i class="fas fa-long-arrow-alt-right mr-2"></i>Blog</a>
                                    </li>
                                    <li> <a href="/pricing"><i
                                                class="fas fa-long-arrow-alt-right mr-2"></i>Pricing</a>
                                    </li>
                                    <li> <a href="/contact"><i class="fas fa-long-arrow-alt-right mr-2"></i>Contact
                                            us</a></li>
                                    <li> <a href="/how-it-works"><i class="fas fa-long-arrow-alt-right mr-2"></i>How
                                            it
                                            works</a></li>
                                </ul>
                            </div>
