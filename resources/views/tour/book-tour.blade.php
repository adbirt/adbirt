    ...
    <div class="layout-content" data-scrollable>
        <div class="container-fluid">
            <div class="Formbox">
                ...
                <div class="card">
                    <form action="{{ url('/tour/Book') }}" data-parsley-validate novalidate method="POST" id="myform"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="CheckInDate" parsley-trigger="change" required
                                            placeholder="Check In Date" class="form-control" id="CheckInDate" title="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="CheckOutDate" required placeholder="Check Out Date"
                        ...
                        <div class="form-group text-right m-b-0">
                            ...
                            <a href="{{ url('/tour/view') }}" type="reset"
