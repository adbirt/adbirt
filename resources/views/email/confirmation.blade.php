                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td bgcolor="#ffffff" width="100" align="left"><a
                                                href="https://www.adbirt.com/" target="_blank"><img alt="Adbirt Logo"
                                                    src="https://www.adbirt.com/public/images/adbirt-email-logo.png"
                                                    width="52" height="78"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="right"
                                                        ...
                                                        <span style="color: #666666; text-decoration: none;">Welcome to
                                                            Adbirt<br>Let's get your Ads Running.</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <td align="center" style="padding: 25px 0 0 0;" class="padding-copy">
                        <table border="0" cellspacing="0" cellpadding="0" class="responsive-table">
                            <tr>
                                <td>&nbsp;</td>
                                <td align="center">
                                    <a href="{{ route('user.doactivate', ['key' => $rand]) }}" target="_blank"
                                        style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; font-weight: bold; color: #ffffff; text-decoration: none; background-color: #BC6A44; border-top: 15px solid #BC6A44; border-bottom: 15px solid #BC6A44; border-left: 125px solid #BC6A44; border-right: 125px solid #BC6A44; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; display: inline-block;"
                                        class="mobile-button">
                                        Activate &rarr;
                                    </a>
                                </td>
                                            ...
                                            <tr>
                                                <td align="center" valign="middle"
                                                    ...
                                                    <span class="appleFooter" style="color:#666666;">13 Aire Close,
                                                        ...
                                                        Chester, United Kingdom</span><br><a class="original-only"
                                                        style="color: #666666; text-decoration: none;">Unsubscribe</a><span
                                                        class="original-only"
                                                        style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span><a
                                                        style="color: #666666; text-decoration: none;">View this email
                                                        in your browser</a>
                                                </td>
                                            </tr>
                                        </table>
