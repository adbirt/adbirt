    ...
    <p class="btn-group pull-md-left" >
        ...
        <form action="{{ url('/filter/product') }}" method="GET" id="filter" name="myform" >
                ...
                <div class="col-md-12">
                    <div class="input-group searchbox">
                        <span class="input-group-addon" id="searchicon"> 
                             <select name="Cat_id" data-placeholder="Select an option" class="form-control" id="Cat_id">
                        ...
                        <input type="text" name="searchByname" id="searchByname"  class="form-control" placeholder="Search Products..">  
            ...
            <div class="row detailsproduct">
                <div class="col-md-4">
                    <input type="search" name="searchByLoc" id="searchBy" class="form-control" placeholder="Enter Location">
                </div>
                
                <div class="col-md-4">
                    <select name="vendor_id" data-placeholder="Select an option" class="form-control" id="vendor_id">
        ...
        <div class="card-columns">
            ...
            <div class="card" id="data-{!! $product->id !!}">
                <div class="card-header bg-white center">
                    <h4 class="card-title"><a href="{{ url('/product/show/'.base64_encode($product->id)) }}">{!! ucfirst($product->product_name) !!}</a></h4>
                    <div>
                ...
                <a href="{{ url('/product/show/'.base64_encode($product->id)) }}">
                    <img src="../uploads/{!! $product->product_image !!}" class="productimg" alt="Card image cap" style="width:100%;">
                </a>
                <div class="card-block">
                    ...
                    <div class="form-group row">
                        <span class="text-success" style="font-size:21px;">${!! $product->product_price !!} {{-- + $1* --}}</span> 
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <a href="javascript:void(0);" Onclick=Buy({{ $product->id }},{{ $product->product_price }},{{ $product->product_shipping_cost }});><button type="button"  class="btn btn-primary btn-rounded">Buy Now</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <span class="text-success" style="font-size:21px;">${!! $product->product_price !!}</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
function Buy(id,price,shipingCost){
    ...
    swal({
      title: "Are you sure?",
      text: "You want to buy this product! An additional charge of $1 & shipping cost of $"+ shipingCost +" will be charged so the actual cost would have been $"+ price +", it ended up being $"+ totalPrice +"",
      type: "warning",
      showCancelButton: true,
      confirmButtonClass: 'btn-danger',
