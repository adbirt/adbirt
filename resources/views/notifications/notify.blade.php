                            ...
                            <div class="row  @if ($value->status == 'Unseen') notifypending @else  @endif ">
                                ...
                                <div class="col-md-12 notifyrow">
                                    <div class="col-md-8 bordernotify">
                                        <label class="notifylabel longcontent">Content :</label> <span
                                            class="notifycontent">{!! $value->content !!}</span>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="notifylabel">Type :</label> <span
                                            class="notifycontent text-color">{!! ucfirst($value->type) !!}</span>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="notifylabel">Date :</label> <span
                                            class="notifycontent text-color">{!! date('d-M-Y h:s A', strtotime($value->created_at)) !!}</span>
                                    </div>
                                </div>
                            </div>
                            <br>
