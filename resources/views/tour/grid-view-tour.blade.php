...
<div class="layout-content" data-scrollable>
    ...
    <div class="card-columns">
     ...
     <div class="card">
      <div class="card-header bg-white center">
        <h4 class="card-title"><a href="{{ url('/tour/show/'.base64_encode($tour->id)) }}">{!! ucwords($tour->tour_name) !!}</a></h4>
        <div>
      ...
      <a href="{{ url('/tour/show/'.base64_encode($tour->id)) }}">
       <img src="{!! asset('assets/tourPhotos/'.$tour->tour_image) !!}" class="tourimg" alt="Card image cap" style="width:100%;">
     </a>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <div class="row">
            ...
            <div class="col-md-6">
             <a href="{{ url('/tour/Buy/'.base64_encode($tour->id)) }}" Onclick="if(confirm('Are u sure want to Buy')){return true;}return false;"> <button type="button"  class="btn btn-primary btn-rounded">Buy Now</button></a>
           </div>
         </div>
       </div>
     </div>
  ...
  <ul class="ActionMenu" style="margin-left: 108px;">
    ...
    <li class="ActionMenuLi">
      <a href="{{ url('/tour/delete/'.base64_encode($tour->id)) }}" Onclick="if(confirm('Are u sure want to delete')){return true;}return false;">
        Delete
      </a>
    </li>
  </ul>
