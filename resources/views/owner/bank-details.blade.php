    ...
    <div class="layout-content" data-scrollable>
        <div class="container-fluid">
            ...
            <div class="Formbox">
                ...
                <div class="card">
                    <form action="{{ url('/owner/bank-details') }}" data-parsley-validate novalidate method="POST"
                        ...
                        @if (count($arrBankDetails) == 0)
                            ...
                            <div class="form-group row">
                                {!! Form::label('how_pay', 'How to Pay* :', ['class' => 'col-sm-3 form-control-label']) !!}
                            ...
                            <div class="form-group row" id="paypal_div">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="email" name="paypal_email_id"
                                            id="paypal_email_id" required />
                                    </div>
                                </div>
                            </div>
                        ...
                        @else
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="input-group">
                                        <input type="radio" name="payment_type" value="paypal" @if (isset($arrBankDetails->payment_type) && $arrBankDetails->payment_type == 'paypal') checked @endif>
                                        PayPal
                                        <input type="radio" name="payment_type" value="bank" @if (isset($arrBankDetails->payment_type) && $arrBankDetails->payment_type == 'bank') checked @endif> Bank
                                        Deposit
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row" id="paypal_div">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="email" name="paypal_email_id"
                                                id="paypal_email_id" required @if (isset($arrBankDetails->paypal_email_id) && $arrBankDetails->paypal_email_id != '') value="{{ $arrBankDetails->paypal_email_id }}" @endif />
                                        </div>
                                    </div>
                                </div>
                            @else
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="bank_name" id="bank_name"
                                                    @if (isset($arrBankDetails->bank_name) && $arrBankDetails->bank_name != '') value="{{ $arrBankDetails->bank_name }}" @endif />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="bank_holder_name"
                                                    id="bank_holder_name" @if (isset($arrBankDetails->bank_holder_name) && $arrBankDetails->bank_holder_name != '') value="{{ $arrBankDetails->bank_holder_name }}" @endif />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="bank_account_no"
                                                    id="bank_account_no" @if (isset($arrBankDetails->bank_account_number) && $arrBankDetails->bank_account_number != '') value="{{ $arrBankDetails->bank_account_number }}" @endif />
                                            </div>
                                        </div>
                                    </div>
                                </div>
