...
<footer class="main-footer">
    <strong>Copyright © 2017 - {{ date('Y') }} <a href="https://adbirt.com/">Adbirt Inc</a>.</strong>
    All rights reserved.
...
<!-- <aside class="control-sidebar control-sidebar-dark" style="display: none; top: 57px; height: 209px;">
    ...
    <div class="p-3 control-sidebar-content os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-scrollbar-vertical-hidden os-host-transition" style="height: 209px;">
