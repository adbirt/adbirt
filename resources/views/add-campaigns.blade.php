                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="url"  name="campaign_success_url" required placeholder="e.g https://my-site.com/advert" class="form-control" id="adbirt-selector" title="selector" >
                                    <br />
                                    <span id="adbirt-loader">...</span>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-primiary btn-small" id="adbirt-get-selector" title="get selector" >Set Selector</button>
                                </div>
                            </div>
                        </div>
                        <!--  -->
