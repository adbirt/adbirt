...
<head>
	...
	<!-- SITE TITLE -->
	<title>Pricing - Adbirt</title>
	<!-- Favicon -->
	<link rel="shortcut icon" href="public/assets-revamp/img/favicon.png" type="image/x-icon">
...
<body>
	...
	<div class="page-wrapper">
			...
			<div class="adbirt-page-heading adbirt-size-md adbirt-dynamic-bg"
				...
				<div class="container">
					<div class="adbirt-page-heading-in text-center">
						<h1 class="adbirt-page-heading-title">Pricing</h1>
		...
		<div class="container my-5">
			...
			<div class="row justify-content-center">
				<div class="col-lg-7 col-xl-6">
					<div class="adbirt-section-title text-center wow zoomIn" data-wow-duration="1s"
						...
						<h2 class="text-primary-color font-weight-bold">Adbirt Advertisement Campaign Pricing</h2>
						<p class="text-black">We offer one of the lowest and on a Budget Advertising Pricing, with as
							low as $0.20 your Campaign will be up & running.</p>
					</div>
				</div>
				<!--- END COL -->
			</div>
			...
			<div class="row">
				<!-- <div class=""> -->
				<!-- <div class="owl-carousel- owl-theme adbirt-main-testimonials adbirt-testimonial-slider row"> -->

                <div class="adbirt-best-service-slide col-12 col-md-4 col-lg-4 m-0">
					<div class="adbirt-best-service-img">
						<img src="public/assets-revamp/img/services/cpa.png" alt="CPA" height="232">
					</div>
								...
								<tr>
									<td>
										<div class="d-flex align-items-center justify-content-center">
											<a href="/dashboard"
												class="text-white font-weight-bold bg-primary-color btn">Get started now</a>
										</div>
									</td>
								</tr>
							</tbody>
				...
				<div class="adbirt-best-service-slide col-12 col-md-4 col-lg-4 m-0">
					<div class="adbirt-best-service-img">
						<img src="public/assets-revamp/img/services/cost-per-sale.png" alt="CPS" height="232">
					</div>
					<div class="adbirt-best-service-content">
				...
				<div class="adbirt-best-service-slide col-12 col-md-4 col-lg-4 m-0">
					<div class="adbirt-best-service-img">
						<img src="public/assets-revamp/img/services/cpd.png" alt="CPD" height="232">
					</div>
					<div class="adbirt-best-service-content">
		...
		<footer id="footer" class="adbirt-footer-area">
			<div class="pt-5 pb-0">
							...
							<div class="col-lg-2 col-md-3 col-12 adbirt-footer-link">
								...
								<ul class="adbirt-list-menu">
									...
									<li> <a href="/contact"><i class="fas fa-long-arrow-alt-right mr-2"></i>Contact
											us</a></li>
									<li> <a href="/privacy"><i class="fas fa-long-arrow-alt-right mr-2"></i>Privacy policy</a></li>
								</ul>
							</div>
							<!--- END COL -->
				...
				<div class="adbirt-footer-boottom text-center mt-4">
					<div class="row">
						<div class="col-md-12">
							<p>&copy; 2017 - 2021 Adbirt, Inc. All Rights Reserved</a> </p>
						</div>
						<!--- END COL -->
					</div>
					<!--- END ROW -->
