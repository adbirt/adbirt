<?php
	...
	class SocialMedia
	{
		...
		public function GetSocialMediaSiteLinks_WithShareLinks($args)
		{
			...
			return [
				'add.this'=>'https://www.addthis.com/bookmark.php?url=' . $url,
				...
				'douban'=>'https://www.douban.com/recommend/?url=' . $url . '&title=' . $text,
				...
				'instapaper'=>'https://www.instapaper.com/edit?url=' . $url . '&title=' . $title . '&description=' . $desc,
				...
				'livejournal'=>'https://www.livejournal.com/update.bml?subject=' . $text . '&event=' . $url,
				...
				'renren'=>'https://widget.renren.com/dialog/share?resourceUrl=' . $url . '&srcUrl=' . $url . '&title=' . $text . '&description=' . $desc,
				'skype'=>'https://web.skype.com/share?url=' . $url . '&text=' . $text,
				'sms'=>'sms:' . $phone_number . '?body=' . $text,
				'surfingbird.ru'=>'https://surfingbird.ru/share?url=' . $url . '&description=' . $desc . '&screenshot=' . $image . '&title=' . $title,
				...
				'vk'=>'https://vk.com/share.php?url=' . $url . '&title=' . $title . '&comment=' . $desc,
				'weibo'=>'https://service.weibo.com/share/share.php?url=' . $url . '&appkey=&title=' . $title . '&pic=&ralateUid=',
				'xing'=>'https://www.xing.com/spi/shares/new?url=' . $url,
				'yahoo'=>'https://compose.mail.yahoo.com/?to=' . $email_address . '&subject=' . $title . '&body=' . $text,
			];
		}
	}
