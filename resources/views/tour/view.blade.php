            ...
            <div class="row searchproduct">
                ...
                <div class="col-md-12">
                    <div class="input-group searchbox">
                        <input type="text" name="searchByname" id="searchByname"  class="form-control" placeholder="Search Tour..">  
        ...
        <div class="card-columns">
            ...
            <div class="card" id="data-{!! $tour->id !!}">
                ...
                <a href="{{ url('/tour/show/'.base64_encode($tour->id)) }}">
                    <img src="{!! asset('assets/tourPhotos/'.$tour->tour_image) !!}" class="tourimg" alt="Card image cap" style="width:100%;max-height: 285px;">
                </a>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ url('/book/tour/'.base64_encode($tour->id)) }}" {{-- Onclick=Book({{ $tour->id }},{{ number_format($tour->tour_price,2) }}); --}}><button type="button"  class="btn btn-primary btn-rounded">Book Now</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
