      ...
      <ol class="breadcrumb">
        ...
        <div class="p-a-2 tab-content">
          <div class="tab-pane active" id="first">
             {!! Form::open(array('role' => 'form', 'route' => 'pending.store', 'method' => 'post', 'class' => 'form-horizontal')) !!}
              ...
              <!--<div class="form-group row">
                {!! Form::label('amount', 'Your Name:', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-6 col-md-6">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"> -->
								<i class="material-icons md-18 text-muted">credit_card</i>
							</span>
                     <!-- {!! Form::text('amount',null, array('class' => 'form-control', 'placeholder' => 'Full Name', 'value' => 'Full Name', 'required')) !!} -->
              ...
              <div class="form-group row">
                {!! Form::label('bank', 'Your Company Name:', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-6 col-md-6">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1">
								<i class="material-icons md-18 text-muted">account_balance</i>
							</span>
                    {!! Form::text('bank',null, array('class' => 'form-control', 'placeholder' => 'Company Name', 'required')) !!}
                  </div>
                </div>
              </div>
              <div class="form-group row">
                {!! Form::label('date', 'Your Company Website:', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-6 col-md-4">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon2">
								<i class="material-icons md-18 text-muted">alarm_on</i>
							</span>
                     {!! Form::text('date',null, array('class' => 'form-control', 'placeholder' => 'Website URL', 'id' => 'url', 'required')) !!}
                  </div>
                </div>
              </div>
              <div class="form-group row">
                {!! Form::label('comment', 'What do you want to Promote?:', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-6 col-md-4">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon3">
								<i class="material-icons md-18 text-muted">speaker_notes</i>
							</span>
                    {!! Form::textarea('comment',null, array('class' => 'form-control', 'placeholder' => 'Tell us what your Business is into and what you want to Promote')) !!}
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-sm-8 col-sm-offset-3">
                  <div class="media">
                    <div class="media-left">
                     {!! Form::submit('Claim $10', array('class' => 'btn btn-lg btn-success')) !!}
                    </div>
                  </div>
                </div>
              </div>
