            ...
            {!! Form::open(array('route' => 'postcontact','method'=>'POST')) !!}
                ...
                <div class="col-sm-6 col-md-6">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1">
                      ...
                      {!! Form::text('name', null, array('placeholder' => 'Name of the Alien','class' => 'form-control')) !!}
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6 col-md-6">
                  <div class="input-group">
                    ...
                    {!! Form::text('phone', null, array('placeholder' => 'Phone of the Alien','class' => 'form-control')) !!}
                ...
                <div class="col-sm-6 col-md-4">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon2">
                     ...
                     {!! Form::textarea('message', null, array('placeholder' => 'Explain in detail what the Alien did','class' => 'form-control','style'=>'height:auto','style'=>'width:auto')) !!}
			  ...
			  <div class="media-body media-middle p-l-1">
                      <label class="c-input c-checkbox">
                        ...
                        <span class="c-indicator"></span> I Acknowledge that all Report given about this user is True to the best of my own Knowlege.
                      </label>
                    </div>
					<br />
              <div class="form-group row">
                <div class="col-sm-8 col-sm-offset-3">
                  <div class="media">
                    <div class="media-left">
                     {!! Form::submit('Report User', array('class' => 'btn btn-lg btn-primary')) !!}
                    </div>
                  </div>
                </div>
              </div>
