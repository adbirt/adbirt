    ...
    <div class="col-sm-8 col-sm-push-1 col-md-4 col-md-push-3 col-lg-4 col-lg-push-4">
	  ...
	  <!--<div class="form-group has-feedback" id="phoneee">	
          ...
          <div class="form-group has-feedback">
		   ...
		   <div class="form-group has-feedback">
            {!! Form::password('password', array('class' => 'form-control', 'placeholder' => 'Password', 'id' => 'passwd')) !!}
            <!-- <span class="glyphicon glyphicon-lock form-control-feedback"></span> -->
          </div>
          <div class="form-group has-feedback">
            {!! Form::password('password_confirmation', array('class' => 'form-control', 'placeholder' => 'Confirm Password', 'id' => 'cnpasswd')) !!}
