...
class MessageFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $req = (new MessageFactory())->createRequest('GET', 'https://www.foo.com', ['body' => ['abc' => '123']]);
    ...
    public function testCreatesRequestWithPostBodyAndPostFiles()
    {
        ...
        $req = (new MessageFactory())->createRequest('GET', 'https://www.foo.com', [
            'body' => [
                'abc' => '123',
                'def' => $pf,
                'ghi' => $pfi
    ...
    {
        (new MessageFactory())->createRequest('GET', 'https://test.com', ['foo' => 'bar']);
    }

    public function testOptionsAddsRequestOptions()
    {
        $request = (new MessageFactory())->createRequest(
            'GET', 'https://test.com', ['config' => ['baz' => 'bar']]
        );
    ...
    {
        $request = (new MessageFactory())->createRequest('GET', 'https://www.test.com/', [
            'cookies' => ['Foo' => 'Bar']
        ]);
        $cookies = null;
    ...
    {
        $request = (new MessageFactory())->createRequest('GET', 'https://foo.com', [
            'query' => ['Foo' => 'Bar']
        ]);
    ...
    {
        (new MessageFactory())->createRequest('GET', 'https://foo.com', [
            'query' => 'foo'
        ]);
    }
    ...
    {
        $request = (new MessageFactory())->createRequest('GET', 'https://foo.com?test=abc', [
    ...
    public function testCanAddSubscribers()
    {
        ...
        $request = $client->get('https://test.com', ['subscribers' => [$mock]]);
    }

    public function testCanDisableExceptions()
    {
        $client = new Client();
        $this->assertEquals(500, $client->get('https://test.com', [
    ...
    {
        $request = (new MessageFactory())->createRequest('PUT', 'https://test.com', ['body' => '0']);
        $this->assertSame('0', (string) $request->getBody());
    }

    public function testCanSetProtocolVersion()
    {
        $request = (new MessageFactory())->createRequest('GET', 'https://t.com', ['version' => 1.0]);
        $this->assertEquals(1.0, $request->getProtocolVersion());
    }

    public function testCanAddJsonData()
    {
        $request = (new MessageFactory())->createRequest('PUT', 'https://f.com', [
            'json' => ['foo' => 'bar']
        ]);
        $this->assertEquals(
            'application/json',
    ...
    {
        $request = (new MessageFactory())->createRequest('POST', 'https://f.com', [
            'json' => ['foo' => 'bar']
        ]);
        $this->assertEquals(
            'application/json',
    ...
    {
        (new ExtendedFactory())->createRequest('PUT', 'https://f.com', [
            'headers' => ['Content-Type' => 'foo'],
            'foo' => 'bar'
        ]);
        try {
            $f = new MessageFactory();
            $f->createRequest('PUT', 'https://f.com', [
                'headers' => ['Content-Type' => 'foo'],
                'foo' => 'bar'
            ]);
    ...
    {
        $request = (new MessageFactory())->createRequest('POST', 'https://f.cn', [
            'body' => ['foo' => ['bar', 'baz']]
        ]);
