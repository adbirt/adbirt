            ...
            <div class="viewtable">
                ...
                <div class="card">
                    @if (Auth::user()->hasRole('vendor'))
                        ...
                        <h5 class="notificationheading text-center p-2 font-weight-bold">For
                            {{ Auth::user()->hasRole('client') || Auth::user()->hasRole('admin') ? 'Publishers' : 'Advertisers' }}
                        </h5>
                        ...
                        <div class="pl-3">
                            ...
                            @if (Auth::user()->hasRole('vendor') || Auth::user()->hasRole('admin'))
                                ...
                                <p class="p-3"> Once you add this code and our system detects the code on your
                                    site,
                                    your Ads
                                    will go Live.
                                    <br />
