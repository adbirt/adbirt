                        ...
                        <div class="card" id="data-{!! $advert->id !!}">
                            ...
                            <a href="{{ url('/campaigns/view/' . base64_encode($advert->user_id)) }}">
                                @if (!empty($advert->profile))
                                    <img src="{!! asset('uploads/company_logo/' . $advert->profile->company_logo) !!}" class="tourimg" alt="Card image cap"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{ url('/campaigns/view/' . base64_encode($advert->user_id)) }}">
                                                    <button type="button" class="btn btn-primary btn-rounded">View
                                                        campaigns</button>
                                                </a>
                                            </div>
                                        </div>
