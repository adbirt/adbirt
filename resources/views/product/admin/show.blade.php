...
@section('content')
    ...
    <form class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <img src="{{('../uploads/'.$product->pro_pics.'.jpg')}}" height="180" width="150" class="img-rounded">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="title" placeholder={{$product->pro_desc}} readonly>
            </div>
        </div>
        <div class="form-group">
