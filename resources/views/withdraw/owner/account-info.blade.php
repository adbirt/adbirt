                    ...
                    <div class="card">
                        <div class="card-header bg-white center">
                            <h4 class="card-title"><a
                                    href="{{ url('/gas/show/' . base64_encode($arrWithdrawalHistory->id)) }}">View Withdrwal
                                    Request</a></h4>
                        </div>
                      ...
                      <tr>
                        ...
                        <th>Total Client</th>
                                    ...
                                    <a class="btn btn-info pull-right"
                                        Onclick="PaidMoney({{ $arrWithdrawalHistory->id }})">Paid Money</a>
                                </div>
                            </div>
            ...
            swal({
                ...
                function() {
                    ...
                    $.ajax({
                            ...
                            data: {
                                id: id,
                                final_price: {!! ucwords($arrWithdrawalHistory->amount) !!}
                            },
                        })
