...
<body class="login">
    ...
    <div class="col-sm-8 col-sm-push-1 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4">
      <div class="center m-a-2">
        <div class="icon-block img-circle">
          <a href="{{ route('dashboard') }}"><i class="material-icons md-36 text-muted">contact_phone</i></a>
        </div>
      </div>
  ...
  @endif
        {!! Form::open(array('route' => 'reset-page-phone', 'method' => 'get')) !!}
