                    ...
                    <div class="card">
                        <div class="card-header bg-white center">
                            <h4 class="card-title"><a
                                    href="{{ url('/tour/show/' . base64_encode($arrTours->id)) }}">{!! ucwords($arrTours->tour_name) !!}</a>
                            </h4>
                    ...
                    <ul id="lightSlider" class="imgSlider">
                        ...
                        <div class="zoom-gallery">
                            @foreach ($TourImage as $image)
                                <a href="{!! asset('assets/tourPhotos/' . $image->tour_image) !!}" data-source="{!! asset('assets/tourPhotos/' . $image->tour_image) !!}" title="Tour Site"
                        ...
                        <div class="card-block">
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                <label
                                    class="control-label space text-uppercase viewproductlabel  col-md-4 col-xs-12 col-sm-4 col-lg-3 ">description
                                    : </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12">
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                <label class="viewproductlabel"> Location : </label><span
                                                    class="text-success" style="font-size:17px;">
                                                    {!! ucwords($arrTours->tour_location) !!}</span>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                <label class="viewproductlabel">Site Visit Policy : </label><span
                                                    class="text-success" style="font-size:17px;">
                                                    {!! ucwords(strip_tags($arrTours->tour_site_visit_policy)) !!}</span>
                                            </div>

                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12 ">
                                            <a class="buyproduct"
                                                href="{{ url('/book/tour/' . base64_encode($arrTours->id)) }}"><button
                                                    type="button" class="btn btn-primary btn-rounded ">Book Now</button></a>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12 ">
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                <label class="viewproductlabel">Price : </label>
                                                <span class="text-success"
                                                    style="font-size:17px;">${!! number_format($arrTours->tour_price, 2) !!}
                                                    {{-- + $1* --}}</span>
                                            </div>
                                            <input type="hidden" name="tourPrice" value="{!! $arrTours->tour_price !!}"
                                                id="tourPrice">
                                        </div>
                            ...
                            @else
                                <div class="form-group row">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Location : </label><span class="text-success" style="font-size:21px;">
                                                {!! ucwords($arrTours->tour_location) !!}</span>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Price : </label><span class="text-success" style="font-size:21px;">
                                                ${!! number_format($arrTours->tour_price, 2) !!}</span>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Site Visit Policy : </label><span class="text-success"
                                                style="font-size:21px;">{!! ucwords($arrTours->tour_site_visit_policy) !!}</span>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (isset($cntBook))
                                <div class="container">
                                    ...
                                    <div class="row cmnt" @if (isset($arrTourCmt) && !empty($arrTourCmt)) style="display:
                                        block;"
                                ...
                                <div class="widget-area no-padding blank">
                                    <div class="status-upload">
                                        <form @if (isset($arrTourCmt) && !empty($arrTourCmt)) action="{{ url('/tour/UpdateComment') }}" @else action="{{ url('/tour/comment') }}" @endif method="post">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="tour_rating" id="TourRate"
                                                value="@if (isset($arrTourCmt) && !empty($arrTourCmt->tour_rating)) {{ $arrTourCmt->tour_rating }} @endif">
                                            ...
                                            @endif
                                            <textarea placeholder="Your Thoughts About This Tour?" name="tour_comment"
                                                class="form-control" required>@if (isset($arrTourCmt) && !empty($arrTourCmt->tour_comment)) {{ $arrTourCmt->tour_comment }} @endif</textarea>
