																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					-->
																					<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">We are almost there! Complete Setup below!</h3>
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Dear, esteemed User, Thank you for setting up a 360 account. You have to Activate your Account to be able to log in, Please kindly follow the link below to verify your email thereby activating your account.</div>
																				</td>
																			</tr>
																		</table>
																		<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{ route('user.doactivate',[ 'key' => $activation_key]) }}" target="_blank">Activate</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																	...
																	<td align="center" valign="top">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																				<p>Best Regards,</p>
<p>The 360 Account Team	</p>
<br />
																					<img src="https://1.bp.blogspot.com/-wg_20kD34sU/WA9YdeRPueI/AAAAAAAAAGY/hBeXw8lKiEgSgrTmUySKU6_avqddApM5gCPcB/s1600/minisoft%2Bgroup.png" width="500" class="flexibleImage" style="max-width:500px;width:auto;display:block;" alt="Text" title="Text" />
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">360 is Powered by Minisoft Group, a Diversified Software/Hardware Manufacturing Company mainly involved in the Development of Problems solving Technologies and Innovation through it's Research and Development Arms, Omegatrons R&D.</div>																			
																				</td>
																			</tr>
																		</table>
																		<!-- // CONTENT TABLE -->
