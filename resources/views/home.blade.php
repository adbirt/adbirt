...
<div class="main">
    <div class="content">
        ...
        <div class="features" id="features">
            <div class="wrap">
                <h2>Adbirt for <span class="text-primary-color" style="font-size: 64px !important;">Advertisers</span></h2>
            ...
            <div class="wrap">
                ...
                <div class="features_grids">
                    <div class="section group">
                        ...
                        <div class="grid_1_of_4 images_1_of_4">
                            <img src="{{ asset('images/earn-and-withdraw-instantly-from-adbirt-publisher-account.jpg') }}">
