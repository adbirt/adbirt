                        ...
                        <div class="options_grp">
                            <ul class="list-group ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header"
                                ...
                                <li class="list-group-item ui-tabs-tab ui-corner-top ui-state-default ui-tab @if (Request::segment(1) == 'dashboard')  ui-state-active ui-tabs-active @endif"
                                    ...
                                    aria-selected="true" aria-expanded="true">
                                    <a href="file:///home/danroyal001/websites/Adbirt%20New%20Dashboard/gambolthemes.net/html-items/modernCamp/index.html#tabs-1"
                                        role="presentation" tabindex="-1" class="ui-tabs-anchor @if (Request::segment(2) == 'add-campaigns') active ui-tabs-active @endif" id="ui-id-1">Add
                                        new Campaign</a>
                                </li>
                                ...
                                <li class="list-group-item ui-tabs-tab ui-corner-top ui-state-default ui-tab @if (Request::segment(1) == 'dashboard') ui-state-active ui-tabs-active @endif"
                                    ...
                                    aria-selected="true" aria-expanded="true">
                                    <a href="file:///home/danroyal001/websites/Adbirt%20New%20Dashboard/gambolthemes.net/html-items/modernCamp/index.html#tabs-1"
                                        role="presentation" tabindex="-1" class="ui-tabs-anchor @if (Request::segment(2) == 'view-campaigns') active ui-tabs-active @endif"
                                ...
                                <li class="list-group-item ui-tabs-tab ui-corner-top ui-state-default ui-tab @if (Request::segment(1) == 'dashboard')  ui-state-active ui-tabs-active @endif"
                                    ...
                                    aria-selected="true" aria-expanded="true">
                                    <a href="file:///home/danroyal001/websites/Adbirt%20New%20Dashboard/gambolthemes.net/html-items/modernCamp/index.html#tabs-1"
                                        role="presentation" tabindex="-1" class="ui-tabs-anchor @if (Request::segment(1) == 'campaigns' && Request::segment(2) == 'active-campaigns') active ui-tabs-active @endif"
                                ...
                                <li class="list-group-item ui-tabs-tab ui-corner-top ui-state-default ui-tab @if (Request::segment(1) == 'dashboard')  ui-state-active ui-tabs-active @endif"
                                    ...
                                    <a href="{{ url('/wallet/view-wallet-history') }}" role="presentation"
                                        tabindex="-1" class="ui-tabs-anchor @if (Request::segment(2) == 'view-wallet-history') active ui-tabs-active @endif" id="ui-id-1">View Wallet Histroy</a>
                                </li>
                                ...
                                <li class="list-group-item ui-tabs-tab ui-corner-top ui-state-default ui-tab @if (Request::segment(1) == 'dashboard')  ui-state-active ui-tabs-active @endif"
                                    ...
                                    <a href="{{ url('/wallet/search-wallet-history') }}" role="presentation"
                                        tabindex="-1" class="ui-tabs-anchor @if (Request::segment(2) == 'search-wallet-history') active ui-tabs-active @endif" id="ui-id-1">Search Wallet Histro</a>
                                </li>
