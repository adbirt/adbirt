        ...
        <div class="alert bg-success alert-styled-left" id="msg">
            ...
            <div class="alert bg-success alert-styled-left" id="msg" style="display:none;">
                ...
                <div class="Formbox viewtable">
                    ...
                    <a href="{{ url('/tour/grid-view-tour') }}" class="btn btn-white"><i class="material-icons">dashboard</i></a>
                            ...
                            <tbody>
                                ...
                                <tr id="data-{!! $value->id !!}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            <span class="label label-success" style="cursor: pointer;" data-toggle="dropdown" aria-hidden="true">Approved</span>
                                            <ul class="dropdown-menu dropAction">
                                                <li>
                                                    <a href="{{ url('/tour/ChngeStatusToReject/'.base64_encode($value->id)) }}">
                                        ...
                                        <div class="dropdown">
                                            <span class="label label-danger" style="cursor: pointer;" data-toggle="dropdown" aria-hidden="true">Rejected</span>
                                            <ul class="dropdown-menu dropAction">
                                                <li>
                                                    <a href="{{ url('/tour/ChngeStatusToApprove/'.base64_encode($value->id)) }}">
                                        ...
                                        @else
                                        <div class="dropdown">
                                            <span class="label label-warning" style="cursor: pointer;" data-toggle="dropdown" aria-hidden="true">Pending</span>
                                            <ul class="dropdown-menu dropAction">
                                                <li>
                                                    <a href="{{ url('/tour/ChngeStatusToApprove/'.base64_encode($value->id)) }}">
                                                        <i class="fa fa-check" style="color:red;" aria-hidden="true"></i>
